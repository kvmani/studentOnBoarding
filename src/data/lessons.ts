...
export const lessons: Lesson[] = [
  ...
  },
  {
    ...
    sections: [
      {
        ...
        blocks: [
          {
            type: "image",
            src: "tutorial-assets/vscode-overview.svg",
            alt: "Annotated VS Code interface showing Explorer, editor, terminal, activity bar and status bar.",
            caption: "VS Code is not just a text editor. The Explorer, editor, terminal, command palette and status bar work together."
          },
          {
            type: "bullets",
            items: [
    ...
    links: [{ label: "Help or mentor contact", configKey: "helpDeskOrContactUrl" }],
    nextLessonIds: ["vscode-offline-extensions", "python-basics", "python-venv-windows", "jupyter-notebooks-vscode"]
  },
  {
  ...
  },
  {
    ...
    links: [{ label: "Internal virtual environment tutorial", configKey: "pythonVirtualEnvTutorialUrl" }],
    ...
    sections: [
      {
        ...
        blocks: [
          {
            type: "paragraph",
            text: "A model starts with adjustable numbers called parameters. Training changes those parameters so model predictions become closer to the target labels."
          },
          {
            type: "equation",
